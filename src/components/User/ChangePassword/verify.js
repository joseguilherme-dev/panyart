...
function VerifyOTP(props) {
  ...
  // Code validation
  useEffect(() => {
    if (code.length === 6) setValidCode(true);
    ...
    >
      <div className="container">
        ...
        <small>
          ...
          <a
            onClick={(e) => {
              if (resendAvailable) handleResend(e);
              else console.log("resend not avaiable.");
            }}
          >
            <u>
              <strong>here</strong>
          ...
          <br />
          Be sure to check your <strong>spam</strong> and <strong>trash</strong>{" "}
          folders.
        </small>
