...
function Edit () {
    ...
    useEffect(() => {
        ...
        if (nickname.length < 3) setValidForm(false); else setValidForm(true)
    ...
    useEffect(() => {(async () => await getEditValue())()}, [])
                ...
                <div className='row justify-content-center text-center'>
                    <div className='col-5 mt-3 mb-5 color_third'>
                        ...
                        <div className='px-5 mt-5'>
                            ...
                            <h3><strong>Edit your account!</strong></h3>
                            <p className='mb-4'>
                                Edit your contact information and nickname ;)
                            </p>
                            <div className='row text-center'>
                                <div className='col-12 mb-4'>
                                    <small><strong>Nickname:</strong></small>
                                    <input
                                        type='text'
                                        placeholder='Nickname'
                                        onChange={(e) => setNickname(e.target.value)}
                                        defaultValue={nickname}
                                        className='py-1 text-center px-3 w-100'></input>
                                </div>
                            </div>
                            <div className='row text-center'>
                                <div className='col-6'>
                                    <small><strong>Discord:</strong></small>
                                    <input
                                        type='text'
                                        placeholder='Discord'
                            ...
                            <div className='row mt-3 mb-4 text-center'>
                                ...
                                <div className='col-6'>
                                    <small><strong>Instagram:</strong></small>
                                    <input
                                        type='text'
                            ...
                            <button disabled={!validForm} onClick={(e) => {handleSubmit(e)}} className='mt-4 btn hvr-wobble-top btn-lg btn-custom_1 w-100 px-4 me-3'>
                                Edit
                            </button>
                        </div>      
                    </div>
