...
import icon1 from "../assets/img/prices/illustrations/icon1.png";
import icon2 from "../assets/img/prices/illustrations/icon2.png";
...
class Commissions extends Component {
  render() {
    return (
      ...
      >
        <h2>♥ ILLUSTRATIONS ♥ </h2>
        <h5>Here you can see examples and the prices of my art!</h5>
        <br />
        <div className="row justify-content-center align-items-center">
          <div className="col-12 col-md-4 py-2 text-end">
            <img src={icon1} className="img-thumbnail" width="100%" alt="" />
          </div>
          <div className="col-12 col-md-4 py-2 text-start">
            <img src={icon2} className="img-thumbnail" width="100%" alt="" />
          </div>
        </div>
        <h4>
          <br />
          <strong>Icon: $35 (extra character +$25)</strong>
          <br />
          <br />
          <br />
        </h4>
        ...
        <h4>
          <br />
          <strong>Bust: $50 (extra character: +$40)</strong>
          <br />
          <br />
          <br />
        </h4>
        ...
        <h4>
          <br />
          <strong>Halfbody: $60 (extra character: +$50)</strong>
          <br />
          <br />
          <br />
        </h4>
        ...
        <h4>
          <br />
          <strong>Fullbody: $70 (extra character: +$60)</strong>
          <br />
          <br />
          <br />
        </h4>
        ...
        <h4>
          <br />
          <strong>Chibi: $35 (extra character: +$25)</strong>
          <br />
          <br />
          <br />
        </h4>
        ...
        <h4>
          <br />
          <strong>Icon Chibi: $25 (extra character: +$15)</strong>
          <br />
          <br />
          <br />
        </h4>
        ...
        <h4>
          ...
          <br />
          <br />- Check out more examples on my
          <a
